...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void showAlert() {
        ...
        dialog.setTitle("Enable Location")
                .setMessage("Ypur Location Setting is set to Off.\n Please Enable Location to use this App")
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLocation==null){
            ...
            Toast.makeText(getApplicationContext(),"Detecting Location.Please Wait...",Toast.LENGTH_LONG).show();
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        reference.child(MobileNumber).child("Location").child("longtitude").setValue(location.getLongitude());
        reference.child(MobileNumber).child("Location").child("latitude").setValue(location.getLatitude());
